      ...
      <MotionPage className="relative overflow-hidden">
        ...
        <MotionReveal>
          <section className="flex min-h-[calc(100svh-64px)] items-center px-4 pb-12 pt-14 sm:min-h-[calc(100svh-72px)] sm:px-6 sm:pb-16 sm:pt-20 lg:px-8">
            <MotionStagger className="mx-auto flex w-full max-w-3xl flex-col items-center gap-5 text-center sm:gap-7">
              ...
              <MotionItem className="flex w-full flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
                <Link
                  href="/"
